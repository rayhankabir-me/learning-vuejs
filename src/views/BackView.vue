    ...
    <div class="w-2/5 bg-white shadow dark:bg-gray-800 p-10 mx-auto">
      <form @submit.prevent="handleLogin" class="w-full">
        ...
        <div>
          ...
          <p v-if="getErrors?.data?.msg" class="mt-2 text-sm text-red-600 dark:text-red-500">
            <span class="font-medium">{{ getErrors?.data?.msg }}</span>
          </p>
